...
module.exports = () => {
    ...
    describe('labelizeUserAgent', () => {
        ...
        const userAgents = [
            ...
            ['AppleCoreMedia/1.0.0.16R5303d (Apple Watch; U; CPU OS 5_0 like Mac OS X; en_us)', ['Smart Speakers', 'Apple', 'Apple Watch']],
            ['(null)/(null) watchOS/5.0.1 model/Watch3,4 hwp/t8004 build/16R381 (6; dt:156)', ['mobile', 'Apple', 'Apple Podcast']],
